...
3. Use `@/components/ui/skeleton` with the shared shimmer effect.
4. Support accessibility: `role="status"`, `aria-busy="true"`, `aria-label="Loading..."`, and `<span className="sr-only">`.
