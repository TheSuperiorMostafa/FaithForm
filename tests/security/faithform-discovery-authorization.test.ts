...
const nearby = read("lib/faithform/nearby.ts");
const feed = read("lib/faithform/announcements-feed.ts");
const installations = read("lib/faithform/push/installations.ts");
const outbox = read("lib/faithform/push/outbox.ts");
const adapters = read("lib/faithform/push/adapters.ts");
const publishHook = read("lib/faithform/push/publish-hook.ts");
