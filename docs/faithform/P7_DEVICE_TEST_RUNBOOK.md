...
| Requirement | Why |
|---|---|
| A non-production FaithForm deployment | Never test against a congregation's real attendance |
...
| **Expect** | No measurable difference attributable to FaithForm. **No figure is claimed until this runs** |
| **Status** | ⛔ Pending |
