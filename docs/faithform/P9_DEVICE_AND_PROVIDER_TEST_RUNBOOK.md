...
| # | Step | Expect |
| --- | --- | --- |
| 1 | Open **Live streaming → Library** on a fresh install of 0060 | Every item says **Not in FaithForm**. Nothing is published by the migration. |
| 2 | Open FaithForm, go to the church | No live area. Empty archive. |
| 3 | Publish one recording as *Anyone using FaithForm* | It appears in the app within one pull-to-refresh. |
