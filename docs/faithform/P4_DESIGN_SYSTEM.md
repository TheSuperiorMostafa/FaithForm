# Prompt 4 — The FaithForm design system

Canonical source: `design/faithform/tokens.json` (v1.0.0) and
`design/faithform/components.json`. Native constants are **generated**, never
hand-written.

## Visual direction

FaithForm should feel like a **place**, not a product dashboard.
...
tables and a sidebar; FaithForm is a visitor app with editorial spacing.
...
Outputs:
- `apps/faithform-ios/Sources/FaithFormKit/Generated/DesignTokens.swift`
- `apps/faithform-android/core/design/src/main/kotlin/…/DesignTokens.kt`
...
A Swift test asserts `FaithFormTokens.version == "1.0.0"`; a mismatch means
