...
NSLocationWhenInUseUsageDescription
  FaithForm uses your location to check you in when you arrive for a service at
  your church.

NSLocationAlwaysAndWhenInUseUsageDescription
  FaithForm checks you in when you arrive for a service, even when the app is
