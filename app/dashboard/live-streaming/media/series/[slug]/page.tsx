...
export default async function MediaSeriesDetailPage({
  params,
}: {
  ...
  return (
    <div className="flex flex-col gap-6">
      <MediaPageHeader
        ...
        backHref="/dashboard/live-streaming/media/series"
      ...
      <div className="flex flex-col gap-3">
        <h3 className="font-heading text-base font-bold">In this series</h3>
        <MediaGrid
          items={inSeries}
