...
import io.faithform.app.contract.ErrorBody
import io.faithform.app.contract.FieldIssue
import io.faithform.app.contract.Meta
...
data class ApiException(
    ...
    companion object {
        ...
        fun from(body: String?, status: Int, requestId: String?): ApiException {
            if (body != null) {
                runCatching { FaithFormJson.decodeFromString<MobileFailure>(body) }
                    .getOrNull()
                    ?.let { failure ->
                        return ApiException(
