...
class ApiCheckInSubmitter(
    ...
    override suspend fun submit(
        ...
        val result = try {
            ...
            // gave.
            throw CheckInTransportException(error.message ?: "FaithForm could not reach the server.")
        }

        val value = result.value
            // A 200 with no body is not a check-in.
            ?: throw CheckInTransportException("FaithForm could not reach the server.")
