...
struct MediaContractTests {
    ...
    func liveDecodes() throws {
        ...
        let decoded = try JSONDecoder.faithform.decode(LiveMediaResponse.self, from: json)
        ...
        """.data(using: .utf8)!
        #expect(try JSONDecoder.faithform.decode(LiveMediaResponse.self, from: empty).live == nil)
    }
    ...
    func archiveDecodes() throws {
        ...
        let page = try JSONDecoder.faithform.decode(MediaPage.self, from: json)
    ...
    func grantDecodes() throws {
        ...
        let grant = try JSONDecoder.faithform.decode(PlaybackGrant.self, from: json)
    ...
    func noEligibilityReasonReachesAVisitor() throws {
        ...
        let page = try JSONDecoder.faithform.decode(MediaPage.self, from: json)
        let encoded = String(data: try JSONEncoder.faithform.encode(page.items[0]), encoding: .utf8)!
    ...
    func additiveFieldsIgnored() throws {
        ...
        """.data(using: .utf8)!
        #expect(try JSONDecoder.faithform.decode(MediaPage.self, from: json).items.isEmpty)
    }
}
...
struct CapabilityHandlingTests {
    ...
    func neverInResumeStore() async {
        ...
        for entry in stored {
            let encoded = String(data: try! JSONEncoder.faithform.encode(entry), encoding: .utf8)!
