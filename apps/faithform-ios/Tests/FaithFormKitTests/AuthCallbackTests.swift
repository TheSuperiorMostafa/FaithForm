...
/// `contracts/faithform/v1/auth-callback.json`, decoded loosely so an added
...
private struct CallbackContract {
    ...
    var faithform: [String: Any] { json["faithform"] as? [String: Any] ?? [:] }
...
struct AuthCallbackContractTests {
    ...
    func constantsMatchContract() throws {
        ...
        #expect(AuthCallbackLink.scheme == contract.faithform["scheme"] as? String)
