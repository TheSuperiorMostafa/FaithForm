...
struct RoutingTests {
    ...
    func parsesKnownLinks() {
        #expect(DeepLinkParser.parse(URL(string: "faithform://home")!) == .home)
        #expect(DeepLinkParser.parse(URL(string: "faithform://account")!) == .account)
        #expect(DeepLinkParser.parse(URL(string: "faithform://account/privacy")!) == .accountPrivacy)
        #expect(DeepLinkParser.parse(URL(string: "faithform://discover")!) == .churchDiscovery)
        #expect(DeepLinkParser.parse(URL(string: "faithform://church/grace-community")!) == .church(slug: "grace-community"))
        #expect(DeepLinkParser.parse(URL(string: "faithform://church/grace/watch")!) == .watch(churchSlug: "grace"))
        #expect(DeepLinkParser.parse(URL(string: "faithform://church/grace/give")!) == .give(churchSlug: "grace"))
    }
    ...
    func rejectsUnknownLinks() {
        let bad = [
            ...
            "faithform://",                          // nothing
            "faithform://nope",                      // unknown root
            "faithform://church",                    // missing slug
            "faithform://church/GRACE",              // uppercase is not a valid slug
            "faithform://church/../../etc/passwd",   // traversal
            "faithform://church/grace/unknown",      // unknown leaf
            "faithform://church/grace/watch/extra",  // trailing junk
            "faithform://account/privacy/extra",
        ]
        for raw in bad {
    ...
    func urlResolution() {
        let url = URL(string: "faithform://church/grace/give")!
