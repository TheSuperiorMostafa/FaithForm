...
struct FeedTests {
    ...
    func offlineShowsLabelledCache() async {
        ...
        let items = try! JSONDecoder.faithform.decode(
...
struct FeedFormattingTests {
    ...
    func instantParsing() {
        #expect(FaithFormInstant.parse("2026-08-30T14:00:00Z") != nil)
        #expect(FaithFormInstant.parse("2026-08-30T14:00:00.123Z") != nil)
        #expect(FaithFormInstant.parse("not a date") == nil)
    }
