...
struct ContractTests {
    ...
    func bootstrapFixtures() throws {
        for name in [
            ...
            let decoded = try JSONDecoder.faithform.decode(MobileSuccess<Bootstrap>.self, from: data)
            #expect(decoded.ok)
    ...
    func firstRun() throws {
        let bootstrap = try JSONDecoder.faithform
    ...
    func additiveFields() throws {
        let decoded = try JSONDecoder.faithform
    ...
    func deprecation() throws {
        let failure = try JSONDecoder.faithform
    ...
    func pagination() throws {
        let first = try JSONDecoder.faithform
        ...
        let last = try JSONDecoder.faithform
    ...
    func geofenceConfigurationDecodes() throws {
        ...
        #expect(region.regionId.hasPrefix("faithform.campus."))
