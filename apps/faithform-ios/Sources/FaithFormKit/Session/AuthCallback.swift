...
/// suite through `contracts/faithform/v1/auth-callback.json`. Everything about
...
public enum AuthCallbackLink {
    public static let scheme = "faithform"
    ...
    public static let canonical = "faithform://auth/callback"
