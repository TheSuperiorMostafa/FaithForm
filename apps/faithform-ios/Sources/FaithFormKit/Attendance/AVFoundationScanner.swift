...
/// The only file in FaithForm that touches the camera.
///
...
/// an image or write one to disk. FaithForm reads a string off a screen at the
...
public actor AVFoundationScanner: QrScanningFacade {
    ...
    public func isAvailable() -> Bool {
        ...
        #else
        // A Mac may well have a camera, but FaithForm is an iOS app and this
    ...
    private final class CaptureBox: @unchecked Sendable {
        ...
        private let queue = DispatchQueue(label: "io.faithform.app.scanner")
